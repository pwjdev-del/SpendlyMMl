...
enum TimesheetReviewMockData {
    ...
    static let teamTimesheets: [TeamTimesheetSummary] = [
        TeamTimesheetSummary(
            id: UUID(uuidString: "T1111111-1111-1111-1111-111111111111")!,
        ...
        TeamTimesheetSummary(
            id: UUID(uuidString: "T2222222-2222-2222-2222-222222222222")!,
        ...
        TeamTimesheetSummary(
            id: UUID(uuidString: "T3333333-3333-3333-3333-333333333333")!,
